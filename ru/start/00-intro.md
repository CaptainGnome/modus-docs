...
Если это первый плагин — читайте эту главу и дальше по туториалу. Если уже есть Rust и нужен контракт ABI — [справочник](../README.md#справочник).
...
| ------------------------------------- | ------------------------ | ---------------------------------------------------------- |
| [Туториал](../README.md#туториал)     | первый плагин            | сверху вниз, каждая глава даёт строку в терминале или файл |
| [Справочник](../README.md#справочник) | контракт, лимиты, ошибки | с оглавления                                               |
