...
Если это первый плагин — запускайте команды в PowerShell по одной и читайте, **что делает каждое слово**. Копировать можно; вслепую — нет. Если тулчейн уже стоит и нужен контракт — [справочник](../introduction.md#справочник).
...
**Важно.** Эта цель не даёт гостю файлы и сокеты (в wasm это зовут WASI). Иначе песочницу можно обойти. Точнее — [справочник](../introduction.md#справочник).
