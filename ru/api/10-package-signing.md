...
Сжатый layout — [ref/08-package](../ref/08-package.md). Политика подписи целиком — [`docs/signing.md`](../../../docs/signing.md) в дереве продукта (из этой главы — `../../../docs/signing.md`).
